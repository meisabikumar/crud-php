...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    // //Validate image
    // $input_image = htmlspecialchars( basename( $_FILES["fileToUpload"]["name"]));
...
echo $statusMsg;
    ...
    if(empty($name_err) && empty($address_err) && empty($salary_err) && empty($img_err) ){
        ...
        // Check if any error and $uploadOk is set to 0 by an error
        ...
        $sql = "INSERT INTO bracelets (name, address, salary) VALUES (?, ?, ?)";
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                header("location: view-bracelets-list.php");
                exit();
            } else{
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <a href="view-bracelets-list.php" class="btn btn-default">Cancel</a>
                    </form>
                </div>
            </div>        
        </div>
